...
```bash
sudo ORIGIN_IP="IP_ADDRESS" bash -c "$(curl -sSL https://raw.githubusercontent.com/tihonme/kaskad1/main/forwarding_install.sh)"
```
...
```bash
bash <(curl -fsSL https://raw.githubusercontent.com/tihonme/kaskad1/main/forwarding_delete.sh)
```
